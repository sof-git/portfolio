    ...
    <v-container class="pt-0">
        ...
        <v-row>
            <v-col cols="12">
                    ...
                    >
                        <v-card max-width="600" class="mx-auto pa-2">
                            ...
                            <v-tabs v-model="tabs[index].tab" class="mt-3 text-center">
                                <v-tab class="text-buttons">Description</v-tab>
                                <v-tab class="text-buttons">Realisations</v-tab>
                                <v-tab class="text-buttons">Stack Technique</v-tab>
                            </v-tabs>
                            <v-card-text>
